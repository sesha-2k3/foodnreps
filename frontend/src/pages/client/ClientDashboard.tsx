...
function NavCard({
  ...
  return (
    <Link to={to}
      ...
      <svg className="ml-auto flex-shrink-0 w-4 h-4 text-gray-300 group-hover:text-gray-400 mt-0.5 transition-colors"
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-8">
      ...
      <section>
        ...
        <div className="space-y-3">
          <NavCard to="/client/workout" title="Workout programme"
          ...
          <NavCard to="/client/diet" title="Diet plan"
      ...
      <section>
        ...
        <div className="space-y-3">
          <NavCard to="/personal/workout" title="Personal workout"
          ...
          <NavCard to="/personal/diet" title="Personal diet"
