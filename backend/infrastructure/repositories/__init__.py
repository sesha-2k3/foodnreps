...
from infrastructure.repositories.assignment_repository import ClientStaffAssignmentRepository
from infrastructure.repositories.diet_repository import DietEntryRepository, DietPlanRepository
from infrastructure.repositories.plan_repository import (
    PlanActivityLogRepository,
    PlanCommentRepository,
    PlanVersionRepository,
)
from infrastructure.repositories.profile_repository import BodyMetricRepository, IntakeProfileRepository
from infrastructure.repositories.user_repository import RefreshTokenRepository, UserRepository
